// Si une session existe déjà, inutile d'afficher le formulaire : on va à l'accueil.
(async () => {
...
// Icônes SVG (style Heroicons) pour le bouton afficher/masquer le mot de passe.
...
// Gestion de la connexion via Supabase Auth.
...
const caseSouvenir = document.getElementById("case-souvenir");
